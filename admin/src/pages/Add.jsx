  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' placeholder='Enter product description' required />
      </div>
      ...
      <button className='w-28 py-3 mt-4 bg-black text-white cursor-pointer' type='submit'>Add Product</button>
